...
"""
my_new_model.add(MobileNetV2(weights='imagenet', include_top=False, pooling='avg'))
"""
...
"""
from tensorflow.python.keras.applications.mobilenetv2 import preprocess_input
"""
...
telling it that we want to apply the pre-trained pre-processing
...
submission.to_csv('mobilenetv2_batch_size_25_25.csv', index=False)
