...
"""
my_new_model.add(NASNetMobile(weights='imagenet', include_top=False, pooling='avg', input_shape = (224, 224, 3)))
"""
...
submission.to_csv('NASNetMobile_batch_size_25_25.csv', index=False)
