...
"""
my_new_model.add(NASNetLarge(weights='imagenet', include_top=False, pooling='avg', input_shape = (331, 331, 3)))
"""
...
submission.to_csv('NASNetLarge_batch_size_25_25.csv', index=False)
