...
"""
we tell tensorflow not to train the first layer which is the ResNet50 model
...
within each of those we have 12 subdirectories (classes) of plant seedlings images
"""
"""
...
"""
we do  as above to setup the way to read the validation data
...
so we go 152 steps (steps_per_epoch) of 25 images,
...
in the dense layer and it makes those updates in 152 steps
...
submission.to_csv('resnet50_batch_size_25_25.csv', index=False)
